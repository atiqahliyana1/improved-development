...
# print(lrrecv.port)
# print(vars(lrrecv))
# print(lrrecv.decode_data())

# # #%% Testing 
# lrsend = Command("LRSEND", SET, port=23, data=246546, confirm=1)
...
# appeui = Command("APPEUI", GET)
# print(appeui.serilize())
# print(appeui.decode_data())
